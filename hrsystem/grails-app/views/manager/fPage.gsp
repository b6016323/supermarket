...
<div class="mainOption"><g:link controller="TeamLeader" class="create" action="create">Create Team Leader</g:link></div>
	...
	<div class="mainOption"><a href='${createLink(action:'assignments',controller:'Manager')}'>Assign Employees To Teams</a></div><div class="mainOption"><g:link controller="Manager" action="managersearch">Search Employees</g:link></div>
</body>
</html>
